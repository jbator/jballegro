...
class Jballegro extends Module {
  ...
  public function createNewAuction() {
    ...
    if (!$this->auctionValidation($result[0]['quantity'])) return false;
  ...
  public function getProductImage($id, $ext = 'jpg') {
    ...
    if (count($result) > 0) {
      ...
      if (file_exists($sourcepath1)) return file_get_contents($sourcepath1);
      else if (file_exists($sourcepath2)) return file_get_contents($sourcepath2);
    }
  }
