...
abstract class AdminTabCore
{
    ...
    protected function _displayAllegroLink($id)
	{
		global $currentIndex, $cookie;
        
        $token = Tools::getAdminToken('AdminModules'.'7'.(int)$cookie->id_employee);
        
        $link = 'index.php?tab=AdminModules&configure=jballegro&token='.$token.'&tab_module=&module_name=jballegro&id_prod='.$id;
		echo '
			<a href="'.$link.'"><img src="../modules/jballegro/logo.gif" alt="Wystaw na allegro" title="Wystaw na allegro" /></a>';
	}
